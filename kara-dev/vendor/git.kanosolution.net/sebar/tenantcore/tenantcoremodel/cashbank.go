...
type CashBank struct {
	...
	MainBalanceAccount string    `form_lookup:"/tenant/ledgeraccount/find|_id|Name"`
	ActualBalance      float64   `form:"hide"`
	ReservedBalance    float64   `form:"hide"`
	TemporaryBalance   float64   `form:"hide"`
