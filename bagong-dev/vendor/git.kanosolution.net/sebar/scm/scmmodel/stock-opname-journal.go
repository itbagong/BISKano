...
type StockOpnameJournal struct {
	...
	ID                string                    `bson:"_id" json:"_id" label:"Stock Opname No." key:"1" form_read_only_edit:"1" form_section:"General" form_section_size:"3"`
...
type StockOpnameJournalLine struct {
	InventJournalLine
	ID          string                  `grid:"hide" form:"hide"` // for relation to Inventory Adjustment only
	...
	QtyActual   string                  `form_label:"Qty Actual"`
