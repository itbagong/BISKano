...
type InventJournalLine struct {
	...
	IRDetailID   string              	   `form_section:"General" form:"hide" grid:"hide"`
	ReffNo       string              	   `form_section:"General" form:"hide" grid:"hide"`
	Qty          float64                   `form_section:"General"`
	RemainingQty float64                   `form_section:"General"`
	UnitID       string                    `form_section:"General" form_lookup:"/tenant/unit/find|_id|Name" label:"UoM"`
