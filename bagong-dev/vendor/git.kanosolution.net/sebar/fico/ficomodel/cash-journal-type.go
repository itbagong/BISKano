...
type CashJournalType struct {
	...
	TransactionType     string                    `form_section:"General" form_items:"LEDGER ACCOUNT|CUSTOMER GROUP|CUSTOMER|CASH IN|CASH OUT|SUBMISSION CASH IN|SUBMISSION CASH OUT"`
...
func (o *CashJournalType) FormSections() []suim.FormSectionGroup {
...
func (o *CashJournalType) TableName() string {
	return "CashJournalTypes"
}

func (o *CashJournalType) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *CashJournalType) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *CashJournalType) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *CashJournalType) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *CashJournalType) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *CashJournalType) PostSave(dbflex.IConnection) error {
	return nil
}
