...
type WorkOrderPlan struct {
	...
	ID                string                     `bson:"_id" json:"_id" label:"WO No" key:"1" form_read_only_edit:"1" form_section:"General" form_section_auto_col:"2" form_section_size:"3"`
	RequestorWOName   string                     ` form_section:"General" label:"WO Requestor"  form_lookup:"/tenant/employee/find|_id|_id,Name"`
	WOName            string                     `form_section:"General" label:"WO Name" form_required:"1"`
	Priority          string                     `form_section:"General" form_items:"Top|Middle|Low"`
	...
	BreakdownType     string                     `form_section:"General" label:"Breakdown Type" form_lookup:"/tenant/masterdata/find?MasterDataTypeID=WOBreakdownType|_id|_id,Name"`
	TrxDate           time.Time                  `form_kind:"date" label:"WO Date" form_required:"1" form_section:"General"` // WO Date
	TrxCreatedDate    time.Time                  `form_section:"General" form_kind:"datetime-local" form_read_only:"1" grid:"hide"`
	...
	BOM               string                     `grid:"hide" form_section:"General" form_label:"BOM" form_lookup:"/mfg/bom/find|_id|_id,Title" form_section_auto_col:"1"`
	Status            ficomodel.JournalStatus    `form_section:"General" form_read_only:"1"`
	StatusOverall     WorkOrderPlanStatusOverall `form_section:"General" form_read_only:"1"`
	WorkDescription   string                     `grid:"hide" form_multi_row:"3" label:"Description" form_section:"General" form_section_auto_col:"1"`
	

	WorkRequestID         string     `form_section:"Work Request Information" label:"Reff WR ID" form_read_only:"1" form_section_auto_col:"2" form_section_show_title:"1"`
	WRDate                time.Time  `form_kind:"date" grid:"hide" form_section:"Work Request Information" form_read_only:"1" label:"WR Date"`
	RequestorName         string     `form_section:"Work Request Information" label:"WR Requestor"  form_lookup:"/tenant/employee/find|_id|_id,Name"`
	RequestorDepartment   string     `form_section:"Work Request Information" form_lookup:"/tenant/masterdata/find?MasterDataTypeID=DME|_id|_id,Name"`
	...
	HullNo                string     `form_section:"Work Request Information" form_read_only:"1" label:"Code Unit"` // TODO: default dari Asset -> Detail -> Hull No. (Read Only)
	NoHullCustomer        string     `form_section:"Work Request Information" form_read_only:"1" label:"No Hull Customer"` // TODO: default dari Asset -> Detail -> Hull No. (Read Only)
	SunID                 string     `grid:"hide" label:"Sun No" form_read_only:"1" form_section:"Work Request Information"` // TODO: kalo diisi, ngelakuin apa ya?
	StartDownTime         *time.Time `form_kind:"datetime-local" form_section:"Work Request Information" form_read_only:"1" grid:"hide"`
	CaroseryCode          string     `grid:"hide" form_section:"Work Request Information" form_read_only:"1"`
	ExpectedCompletedDate time.Time  `grid:"hide" form_kind:"date" form_read_only:"1" form_section:"Work Request Information"`
	Kilometers            float64    `grid:"hide" form_read_only:"1" form_section:"Work Request Information"` // TODO: default dari Asset (editable)
