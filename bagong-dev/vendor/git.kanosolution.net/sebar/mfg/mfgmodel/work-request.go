...
type WorkRequest struct {
	...
	Name              string                            `form_section:"General1" form_required:"1" label:"Requestor" form_lookup:"/tenant/employee/find|_id|Name"` // Requestor ID
	// Department        string                            `form_section:"General1" form_lookup:"/tenant/masterdata/find?MasterDataTypeID=DME|_id|Name" form_read_only:"1"`
	...
	SourceID          string                            `form_section:"General1" grid:"hide" label:"Ref No."`
