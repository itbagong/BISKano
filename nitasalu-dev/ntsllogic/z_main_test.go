...
func TestMain(m *testing.M) {
	...
	defaultConn := datahub.NewHub(datahub.GeneralDbConnBuilderWithTx(fmt.Sprintf(defaultConnStr, dbSvr.URI()), false), true, 50)
