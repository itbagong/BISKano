...
type InventTrxReceipt struct {
	...
	Qty                   float64                    `form_section:"General3" grid:"hide"`
	...
	VendorName            string                     `form_section:"General3" grid:"hide"`
	OriginDestinationID   string                     `form_section:"General3"` // used in GR
	OriginDestinationName string                     `form_section:"General3"` // used in GI
