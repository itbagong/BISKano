...
type ReferenceTemplateItem struct {
	...
	ReferenceType string `form_items:"date|number|text|textarea|lookup|items"`
...

{
	_id: "template 1",
	items: [
		{_id:"A", Label:"Item A", lookup:"/tenant/currencyid/find|_id|Name"},
		{_id:"B", Label:"Item B", lookup:"/tenant/currencyid/find|_id|Name"},
		{_id:"C", Label:"Item C", lookup:"/tenant/currencyid/find|_id|Name"},
	]
}
*/
