...
type SiteEntryMiningDetail struct {
	...
	KM            []KMDetail                `form_section:"KM"`
	SpareAsset    string                    `grid:"hide" form_section:"General2" form_label:"Spare Unit" form_lookup:"/tenant/asset/find?GroupID=UNT|_id|Name"`
...
func (o *SiteEntryMiningDetail) FormSections() []suim.FormSectionGroup {
	return []suim.FormSectionGroup{
		...
		{Sections: []suim.FormSection{
			{Title: "KM", ShowTitle: true, AutoCol: 4},
		}},
		{Sections: []suim.FormSection{
