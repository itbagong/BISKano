...
type Coaching struct {
	...
	Date                   time.Time
	Topic                  string                    `grid:"hide" form_multi_row:"3" form_section:"Coach Suggestion" form_section_auto_col:"2"`
	...
	Target                 string                    `grid:"hide" form_multi_row:"3" form_section:"Coach Suggestion"`
