...
type InventReceiveIssueLine struct {
	...
	OriginalQty float64 // After Post: SettledQty + TrxQty
	SettledQty  float64
	TrxQty      float64
...
type InventReceiveIssueJournal struct {
	...
	CreatedBy 		string                    `grid:"hide" form:"hide" form_read_only:"1"  form_section:"Info"`
	LastUpdateBy 	string                    `grid:"hide" form:"hide" form_read_only:"1"  form_section:"Info"`
