...
type ItemSerial struct {
	...
	SKU          	  string    `form_section:"General"  grid:"hide" form:"hide"  label:"SKU" form_lookup:"/tenant/itemspec/find|SKU|SKU"`
	...
	LifeTimeDate      time.Time `form_section:"General" form_kind:"date" label:"Lifetime date"`
	LifeTimeValue     float64   `form_section:"General" label:"Lifetime value"`
	LifeTimeValueUnit string    `form_section:"General" label:"Lifetime value unit"`
