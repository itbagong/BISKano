...
type VendorJournalType struct {
	orm.DataModelBase       `bson:"-" json:"-"`
	ID                      string `bson:"_id" json:"_id" key:"1" form_read_only_edit:"1" form_section:"General" form_section_size:"3"`
	Name                    string `form_required:"1" form_section:"General"`
	VendorGroup             string `form_section:"General" form_lookup:"/tenant/vendorgroup/find|_id|Name"`
	Vendor                  string `form_section:"General" form_lookup:"/tenant/vendor/find|_id|Name"` // TODO: UI: find Customer where GroupID == choosen VendorGroup
...
func (o *VendorJournalType) TableName() string {
	return "VendorJournalTypes"
}

func (o *VendorJournalType) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *VendorJournalType) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *VendorJournalType) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *VendorJournalType) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *VendorJournalType) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *VendorJournalType) PostSave(dbflex.IConnection) error {
	return nil
}
