...
type WorkOrderPlanReportOutput struct {
	...
	Lines []WorkOrderOutputItem `form:"hide" grid:"hide" form_section:"General"`
...
type WorkOrderOutputItem struct {
	Date                 time.Time           // di inject by beckend waktu save, ditampilkan hanya di tab Output yang diatas sebelah General
	Type                 WorkOrderOutputType // WO Output|Waste Item|Waste Ledger
	InventoryLedgerAccID string
	SKU                  string  `label:"SKU" grid:"hide"`
	Description          string  `grid:"hide"`
	GroupID              string  `grid:"hide"`
	UnitID               string  `label:"UoM"`
	Qty                  float64 // Achieved Qty
}

func (o *WorkOrderPlanReportOutput) TableName() string {
	return "WorkOrderPlanReportOutputs"
}

func (o *WorkOrderPlanReportOutput) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *WorkOrderPlanReportOutput) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *WorkOrderPlanReportOutput) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *WorkOrderPlanReportOutput) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *WorkOrderPlanReportOutput) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *WorkOrderPlanReportOutput) PostSave(dbflex.IConnection) error {
	return nil
}
