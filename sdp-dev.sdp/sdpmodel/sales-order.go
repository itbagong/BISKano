...
type SalesOrderLineGrid struct {
	...
	Spesifications []string            `form_lookup:"/tenant/specvariant/find|_id|Name" label:"Specifications"`
...
type SalesOrder struct {
	...
	TransactionType  string `grid:"hide" form_section:"General" form_items:"Asset|Item"`
	...
	TrxDate   time.Time                 `grid:"hide" form:"hide"`
	Text      string                    `grid:"hide" form:"hide"`
