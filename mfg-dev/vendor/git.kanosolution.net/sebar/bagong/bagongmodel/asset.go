...
type AssetUnit struct {
	Purpose        string     `form_section:"Vehicle Info" form_section_direction:"row" form_section_show_title:"1"  form_section_size:"3" form_items:"BTS|Mining|Trayek|Tourism"`
	...
	Tax            bool       `form_section:"Register Info" label:"Tax"`
	Kir            bool       `form_section:"Register Info"`
	TrayekCode     string     `form_section:"Register Info" label:"Kode Trayek"`
	TrayekName     string     `form_section:"Register Info" label:"Nama Trayek" form_lookup:"/tenant/masterdata/find?MasterDataTypeID=NTR|_id|Name"`
...
type Depreciation struct {
	...
	DepreciationDate   *time.Time `form_section:"General3" form_section_size:"3" form_kind:"date" form_section:"Depreciation"`
	AcquisitionDate    *time.Time `form_section:"General4" form_section_size:"3" form_kind:"date" form_section:"Depreciation"`
...
type UserInfo struct {
	ProjectID      string     `form_lookup:"/sdp/measuringproject/find|_id|ProjectName"`
	...
	AssetDateFrom  time.Time  `form_kind:"date"`
	AssetDateTo    time.Time  `form_kind:"date"`
	SiteID         string     `form_lookup:"/bagong/sitesetup/find|_id|Name"`
