...
type PayrollSubmissionCustom struct {
	ID            string                    `bson:"_id" json:"_id" key:"1" form_read_only:"1" form_section:"General" form_section_auto_col:"3" form_section_direction:"row" grid:"hide" form:"hide"`
	TrxDate       time.Time                 `form_kind:"date" form_section:"General" grid_pos:"3" grid_label:"Transaction Date"`
	SiteID        string                    `form:"hide" grid_pos:"1"`
	...
	Status        string                    `form:"hide" grid_pos:"5"`
