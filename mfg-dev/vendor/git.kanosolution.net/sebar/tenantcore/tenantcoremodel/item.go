...
type ItemGrid struct {
	...
	ItemGroupID string `form_section:"General"`
	//DefaultUnitID string    `form_required:"1" form_section:"General" form_lookup:"/tenant/unit/find|_id|_id,Name"`
...
type Item struct {
	...
	// OtherName            string   `form_section:"General"`
	ItemType             ItemType `form_required:"1" form_read_only_edit:"1" form_section:"General" form_items:"STOCK|VIRTUAL|SERVICE|MAKLOON"`
	ItemGroupID          string   `form_section:"General" form_lookup:"/tenant/itemgroup/find|_id|_id,Name"`
	...
	TaxCodes             []string           `form_section:"General" form_lookup:"/fico/taxcode/find|_id|Name"`
	...
	IsActive             bool               `form_section:"Time Info" form_section_auto_col:"3"`
...
func (o *Item) Indexes() []dbflex.DbIndex {
	return []dbflex.DbIndex{
		...
		{Name: "ItemGroupID", Fields: []string{"ItemGroupID"}},
	}
}
