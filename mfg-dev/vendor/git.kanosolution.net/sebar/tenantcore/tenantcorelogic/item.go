...
func getSpecsByItem(h *datahub.Hub, req *GeneralRequest, parm GetSpecParam) ([]*tenantcoremodel.Item, []*tenantcoremodel.ItemSpec, error) {
	// items, e := GetDataByGeneralRequest(h, new(tenantcoremodel.Item), req, []GetDataByGRParam{
	// 	{Field: "_id", Value: reqItemID},
	// 	{Field: "Name", Value: reqText},
	// }...)
	// if e != nil {
	// 	return nil, nil, e
	// }
	...
	specByItemsParm := req.GetQueryParam().SetWhere(dbflex.In("ItemID", itemIDs...))
...
func getSpecsByVariant(h *datahub.Hub, req *GeneralRequest, parm GetSpecParam) ([]*tenantcoremodel.ItemSpec, error) {
	...
	if e := h.GetsByFilter(new(tenantcoremodel.ItemSpec), dbflex.In("SpecVariantID", varIDs...), &res); e != nil {
		return nil, e
	}
...
func getSpecsBySize(h *datahub.Hub, req *GeneralRequest, parm GetSpecParam) ([]*tenantcoremodel.ItemSpec, error) {
	...
	res := []*tenantcoremodel.ItemSpec{}
	if e := h.GetsByFilter(new(tenantcoremodel.ItemSpec), dbflex.In("SpecSizeID", varIDs...), &res); e != nil {
		return nil, e
	}
...
func getSpecsByGrade(h *datahub.Hub, req *GeneralRequest, parm GetSpecParam) ([]*tenantcoremodel.ItemSpec, error) {
	...
	res := []*tenantcoremodel.ItemSpec{}
	if e := h.GetsByFilter(new(tenantcoremodel.ItemSpec), dbflex.In("SpecGradeID", varIDs...), &res); e != nil {
		return nil, e
	}
