...
var (
	engines = map[string]func(ev kaos.EventHub) (Deployer, error){}
)
...
func NewDeployer(name string, ev kaos.EventHub) (Deployer, error) {
...
func RegisterDeployer(name string, fn func(ev kaos.EventHub) (Deployer, error)) {
	engines[name] = fn
}
