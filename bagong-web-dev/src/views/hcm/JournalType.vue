<template lang="">
  <div class="w-full">
    <data-list
      class="card"
      ref="listControl"
      title="HCGS Journal Type"
      grid-config="/hcm/journaltype/gridconfig"
      form-config="/hcm/journaltype/formconfig"
      grid-read="/hcm/journaltype/gets"
      form-read="/hcm/journaltype/get"
      grid-mode="grid"
      grid-delete="/hcm/journaltype/delete"
      form-keep-label
      form-insert="/hcm/journaltype/save"
      form-update="/hcm/journaltype/save"
      :grid-fields="['Enable']"
...
const FEATUREID = "HCMJournalType";
