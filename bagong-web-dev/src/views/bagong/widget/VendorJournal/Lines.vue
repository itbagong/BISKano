<template>
  <div class="flex flex-col gap-2">
    <data-list
      ...
      grid-config="/fico/vendorjournal/line/gridconfig"
      form-config="/fico/vendorjournal/line/formconfig"
      :form-fields="['TagObjectID1','TagObjectID2','OffsetAccount','Dimension']"
      :grid-fields="['TagObjectID1','TagObjectID2','OffsetAccount','Dimension','Account']"
