<template>
  <div class="w-full bg-white relative export-master">
    <div
        ...
        .filter((e) => {
          return (
            [
              ...
              "Items",
              "item_sku",
            ].includes(e.Key) && e.Download == "true"
          );
        })
        .map((e) => {
          return {
