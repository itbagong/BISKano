<template>
    <div class="w-full">
        <data-list class="card" ref="listControl" title="Cash Journal Type" grid-config="/fico/cashjournaltype/gridconfig"
            form-config="/fico/cashjournaltype/formconfig" grid-read="/fico/cashjournaltype/gets"
            form-read="/fico/cashjournaltype/get" grid-mode="grid" grid-delete="/fico/cashjournaltype/delete"
            form-keep-label form-insert="/fico/cashjournaltype/insert" form-update="/fico/cashjournaltype/update"
...
const FEATUREID = 'CashAndBankJournalType'
