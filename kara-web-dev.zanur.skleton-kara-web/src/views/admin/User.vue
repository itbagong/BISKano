<template>
    <div class="w-full">
        <data-list class="card" ref="grid" title="User" grid-config="/admin/user/gridconfig"
            ...
            :init-app-mode="data.appMode" :init-form-mode="data.formMode" :form-fields="['Status']"
...
function openForm() {
    nextTick(() => {
        nextTick(() => {
            const minLength = 5
            const validChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstyuvxxyz@._-+"
