...
const router = createRouter({
  ...
  routes: [
    ...
    //-- iam
    // { path: "/validate2fa", name: "validate2fa", component: () => import("@/views/iam/Validate2FA.vue"), meta: { guest: true, } },
    ...
    // { path: "/activate-user", name: "public-activate", component: () => import("@/views/iam/ActivateUser.vue"), },
    ...
    // { path: "/me/reset-password", name: "reset_password", component: () => import("@/views/iam/ResetPassword.vue") },
