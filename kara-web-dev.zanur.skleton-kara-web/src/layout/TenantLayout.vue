<template>
  <div
    class="w-full flex pt-[70px] p-5 justify-center bg-main-bg"
    :class="[
      data.menuType == 'full'
        ? 'ml-[200px]'
        : data.menuType == 'mini'
  ...
  <div class="nav_top flex items-center">
    ...
    >
      ...
      <h1 class="cursor-pointer text-[1em]">Kara</h1>
    </div>
    <div
      v-else
    ...
    >
      <h1 class="text-[1em]">
        <mdicon name="cellphone-marker" class="cursor-pointer" width="18" />
      </h1>
    </div>
