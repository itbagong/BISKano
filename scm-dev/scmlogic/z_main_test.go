...
var (
	...
	testDbPort = 27888
	natsPort   = 4333
	svc        = kaos.NewService().SetBasePoint("/v1/scm")
...
func TestMain(m *testing.M) {
	...
	scmlogic.RegisterJournalAPI(svc, dbmod, uimod)
	svc.PrepareRoutes("")
	routes := svc.Routes()
	...
	fns := []injectDataFn{injectLedgerBankMasterData, injectLedgerBankConfigData, injectSCMData, injectUnit}
	for _, fn := range fns {
