...
type SafetyCard struct {
	...
	IsPica            bool                      `grid:"hide" form:"hide"`
...
func (o *SafetyCard) FormSections() []suim.FormSectionGroup {
	return []suim.FormSectionGroup{
		{Sections: []suim.FormSection{
			...
			{Title: "Detail Finding", ShowTitle: false, AutoCol: 1},
			{Title: "Follow Up", ShowTitle: false, AutoCol: 1},
			{Title: "PICA", ShowTitle: false, AutoCol: 3},
