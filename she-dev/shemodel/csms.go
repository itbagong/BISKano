...
type Csms struct {
	...
	StartDate          time.Time                 `form_kind:"date" label:"Start Date" grid:"hide"`
	EndDate          time.Time                 `form_kind:"date" label:"End Date" grid:"hide"`
	CsmsDate          time.Time                 `form_kind:"date" label:"Trx Date"`
