...
Detailed documentation can be found here [http://godoc.eaciitapp.com/pkg/git.kanosolution.net/kano/dbflex/](http://godoc.eaciitapp.com/pkg/git.kanosolution.net/kano/dbflex/)
...
import (
	...
	_ "git.kanosolution.net/kano/dbflex/drivers/json"
)
...
func main() {
	...
	_, err = query.Execute(codekit.M{}.Set("data", data))
	if err != nil {
		panic(err)
	}
...
```go
pipe := []codekit.M{}
pipe = append(pipe, codekit.M{
	"$match": codekit.M{"grade": 1},
})
