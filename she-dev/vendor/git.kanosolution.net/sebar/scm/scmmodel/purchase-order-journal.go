...
type PurchaseOrderJournal struct {
	...
	Name              string       `form_section:"General" form_required:"1" label:"PO Name"`                                   // TODO: seharusnya diganti Text
	...
	ReffNo            []string     `form_section:"General" form_read_only:"1" grid:"hide"`
...
type PurchaseOrderJournalGrid struct {
	...
	ReffNo           []string     `form_section:"General" grid:"hide"`
