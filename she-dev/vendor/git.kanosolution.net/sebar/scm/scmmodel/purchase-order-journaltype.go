...
type PurchaseOrderJournalType struct {
...
func (o *PurchaseOrderJournalType) TableName() string {
	return "PurchaseOrderJournalTypes"
}

func (o *PurchaseOrderJournalType) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *PurchaseOrderJournalType) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *PurchaseOrderJournalType) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *PurchaseOrderJournalType) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *PurchaseOrderJournalType) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *PurchaseOrderJournalType) PostSave(dbflex.IConnection) error {
	return nil
}
