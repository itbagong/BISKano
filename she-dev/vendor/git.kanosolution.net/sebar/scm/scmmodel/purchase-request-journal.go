...
type PurchaseRequestJournal struct {
	...
	ReffNo            []string     `form_section:"General" grid:"hide" form_read_only:"1" form_lookup:"/scm/item/request/find?Status=POSTED|_id|_id,Name" multiple:"1" label:"IR Reff No"`
	...
	TaxCodes        []string `form_section:"Tax" grid:"hide" form:"hide" form_lookup:"/fico/taxcode/find|_id|Name"`
...
type PurchaseRequestJournalGrid struct {
	...
	ReffNo           []string     `form_section:"General" grid:"hide" multiple:"1"`
...
type PurchaseJournalLine struct {
	...
	PPN                    float64               // penjumlahan rupiah semua PPNTaxCodes
	PPH                    float64               // penjumlahan rupiah semua PPHTaxCodes
