...
type PreviewReport struct {
	...
	MultipleRowSignature [][]Signature             `bson:"MultipleRowSignature"` // for multiple row signature, example in cash out preview checked by & approved by
}
