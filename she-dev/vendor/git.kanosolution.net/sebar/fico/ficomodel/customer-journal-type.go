...
type CustomerJournalType struct {
	orm.DataModelBase       `bson:"-" json:"-"`
	ID                      string                    `bson:"_id" json:"_id" key:"1" form_read_only_edit:"1" form_section:"General" form_section_size:"3"`
	Name                    string                    `form_required:"1" form_section:"General"`
	TransactionType         string                    `form_items:"Customer Sales|Credit Note|Mining Invoice - Rent|Mining Invoice - Overtime Driver|General Invoice"`
	NumberSequenceID        string                    `grid:"hide" form:"hide"`
...
func (o *CustomerJournalType) TableName() string {
	return "CustomerJournalTypes"
}

func (o *CustomerJournalType) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *CustomerJournalType) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *CustomerJournalType) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *CustomerJournalType) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *CustomerJournalType) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *CustomerJournalType) PostSave(dbflex.IConnection) error {
	return nil
}
