...
func (o *SheJournalType) FormSections() []suim.FormSectionGroup {
...
func (o *SheJournalType) TableName() string {
	return "SheJournalType"
}

func (o *SheJournalType) FK() []*orm.FKConfig {
	return orm.DefaultRelationManager().FKs(o)
}

func (o *SheJournalType) ReverseFK() []*orm.ReverseFKConfig {
	return orm.DefaultRelationManager().ReverseFKs(o)
}

func (o *SheJournalType) SetID(keys ...interface{}) {
	o.ID = keys[0].(string)
}

func (o *SheJournalType) GetID(dbflex.IConnection) ([]string, []interface{}) {
	return []string{"_id"}, []interface{}{o.ID}
}

func (o *SheJournalType) PreSave(dbflex.IConnection) error {
	if o.ID == "" {
...
func (o *SheJournalType) PostSave(dbflex.IConnection) error {
	return nil
}
